 ...
 * @author sychev
 */
public class PostComUserExec implements UnaryOperator<Command> {
    ...
    public Command apply(Command t) {
        ...
        String result = database.insert(key, new Payment( accountDebet, accountCredet, sum ) ) ? "POST OK" : "POST FALSE";
        
        return new Command(t.getClientName(), t.getTypeRequest(), t.getUrl(), "PostComUserExec response : " + result);
    }
